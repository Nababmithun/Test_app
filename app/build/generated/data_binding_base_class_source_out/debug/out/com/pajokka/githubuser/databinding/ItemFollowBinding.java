...
public final class ItemFollowBinding implements ViewBinding {
  ...
  private ItemFollowBinding(@NonNull CardView rootView, @NonNull CardView cardParent,
  ...
  public static ItemFollowBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_follow, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemFollowBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemFollowBinding((CardView) rootView, cardParent, ivProfile, ivRepo, tvItemName,
          tvLocation, tvRepo, view);
    }
