...
public final class ItemFollowPlaceholderBinding implements ViewBinding {
  @NonNull
  ...
  private ItemFollowPlaceholderBinding(@NonNull CardView rootView, @NonNull CardView cardParent,
  ...
  @NonNull
  public static ItemFollowPlaceholderBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemFollowPlaceholderBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_follow_placeholder, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemFollowPlaceholderBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemFollowPlaceholderBinding((CardView) rootView, cardParent, ivProfile, ivRepo,
