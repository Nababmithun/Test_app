...
public final class ItemPopularBinding implements ViewBinding {
  ...
  private ItemPopularBinding(@NonNull CardView rootView, @NonNull CardView cardParent,
  ...
  public static ItemPopularBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemPopularBinding((CardView) rootView, cardParent, ivProfile, ivRepo, tvItemName,
